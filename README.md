# go.cobot OpenAPI Specification
[![Build Status](https://travis-ci.org/goodylabs/cobot.work.life.svg?branch=master)](https://travis-ci.org/goodylabs/cobot.work.life)
...
6. If you did everything correct, https://goodylabs.github.io/cobot.work.life/ will lead to your new docs
...
- Documentation(ReDoc): https://goodylabs.github.io/cobot.work.life/
- SwaggerUI: https://goodylabs.github.io/cobot.work.life/swagger-ui/
- Look full spec:
    + JSON https://goodylabs.github.io/cobot.work.life/swagger.json
    + YAML https://goodylabs.github.io/cobot.work.life/swagger.yaml
- Preview spec version for branch `[branch]`: https://goodylabs.github.io/cobot.work.life/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://goodylabs.github.io/cobot.work.life/ with url from the message: `Server started <url>`
